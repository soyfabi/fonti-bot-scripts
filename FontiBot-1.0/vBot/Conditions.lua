...
Panel
  ...
  macro(50, function()
    ...
    if (not config.ignoreInPz or not isInPz()) and config.holdUtamo and mana() >= config.utamoCost and not (hasManaShield() or (hasNewManaShield and hasNewManaShield())) then say("utamo vita")
