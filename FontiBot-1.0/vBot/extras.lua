...
if true then
  ...
  if settings.useAll and settings.useAll:len() > 0 then
    hotkey(settings.useAll, function()
      if not (modules.game_console and modules.game_console.isEnabledWASD and modules.game_console.isEnabledWASD()) then return end
...
if true then
  ...
  onKeyPress(function(keys)
    local wsadWalking = modules.game_console and modules.game_console.isEnabledWASD and modules.game_console.isEnabledWASD() or false
